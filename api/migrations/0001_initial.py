# Generated by Django 5.1.6 on 2025-02-14 20:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('doctor', 'Doctor'), ('patient', 'Patient'), ('researcher', 'Researcher')], default='patient', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.doctor')),
                ('scan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.brainscan')),
            ],
        ),
        migrations.CreateModel(
            name='ResearchStudy',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scan', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.brainscan')),
            ],
        ),
    ]
